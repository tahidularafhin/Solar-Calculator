...
function calculateSolar() {
    ...
    var feedback = "";
    feedback += "<p>Based on your average daily uses of " + Math.round(dailyUseKw) + "  Kwh, you need to purchase " + panelsNeeded + " "+ panelName +" solar panels to offset 100% of your electricity bill.</p>";
    ...
    feedback += "<p>Realistics watts needed per hour:" + Math.round(realWattNeeds) + " watts/hour. </p>";
